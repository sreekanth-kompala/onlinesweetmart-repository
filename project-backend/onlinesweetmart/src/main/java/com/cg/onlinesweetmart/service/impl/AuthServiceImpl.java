...
public class AuthServiceImpl implements AuthService {
	...
	public String login(LoginDto loginDto) {
		try {
			...
			throw new SweetMartAPIException(HttpStatus.BAD_REQUEST, "invalid username or password");
		} catch (Exception e) {
			throw new SweetMartAPIException(HttpStatus.BAD_REQUEST, "unexpected error occurred");
		}
	...
	public String register(RegisterDto registerDto) {
		...
		if (!registerDto.getPassword().equals(registerDto.getConfirmPassword())) {
			throw new SweetMartAPIException(HttpStatus.BAD_REQUEST, "password did not match");
		}
